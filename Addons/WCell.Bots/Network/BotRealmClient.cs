...
namespace WCell.Bots.Network
{
    public class BotRealmClient : FakeClientBase<IRealmClient, RealmPacketIn, RealmPacketOut, BotPacketMgr>, IRealmClient
    {
        ...
        public BotRealmClient()
			: base(RealmServer.RealmServer.Instance, BotPacketMgr.Instance)
		{   
            // Empty addons
            this.Addons = new byte[670];
        }
		...
		public new RealmServer.RealmServer Server
		{
			get
			{
                return (RealmServer.RealmServer)m_server;
			}
		}
		...
		{
			return "BotRealmClient '" + Account.Name + "'";
		}
